...
import type { CancellationReasonsResponse } from "@/features/orders/types";
...
export async function GET(request: Request) {
  ...
  try {
    const result = await api.get<CancellationReasonsResponse>(
      "/admin/renewal-requests/cancellation-reasons",
      {
        locale,
        headers: {
    ...
    console.error("Cancellation reasons fetch failed:", error);
