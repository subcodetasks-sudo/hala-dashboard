...
import type { CompletedStatsResponse } from "@/features/orders/types";
...
export async function GET(request: Request) {
  ...
  try {
    const result = await api.get<CompletedStatsResponse>(
    ...
    console.error("Completed renewal request stats fetch failed:", error);
