...
import type { PaymentStatsResponse } from "@/features/orders/types";
...
export async function GET(request: Request) {
  ...
  try {
    const result = await api.get<PaymentStatsResponse>(
    ...
    console.error("Payment renewal request stats fetch failed:", error);
