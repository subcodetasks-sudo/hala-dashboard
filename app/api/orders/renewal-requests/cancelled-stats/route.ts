...
import type { CancelledStatsResponse } from "@/features/orders/types";
...
export async function GET(request: Request) {
  ...
  try {
    const result = await api.get<CancelledStatsResponse>(
    ...
    console.error("Cancelled renewal request stats fetch failed:", error);
