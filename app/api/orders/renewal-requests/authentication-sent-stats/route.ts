...
import type { AuthenticationSentStatsResponse } from "@/features/orders/types";
...
export async function GET(request: Request) {
  ...
  try {
    const result = await api.get<AuthenticationSentStatsResponse>(
    ...
    console.error(
      "Authentication-sent renewal request stats fetch failed:",
      error,
    );
