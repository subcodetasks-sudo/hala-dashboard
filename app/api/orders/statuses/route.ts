...
import type { OrderStatusesResponse } from "@/features/orders/types";
...
export async function GET(request: Request) {
  ...
  try {
    const result = await api.get<OrderStatusesResponse>(
      "/admin/renewal-requests/statuses",
      {
        locale,
        headers: {
    ...
    console.error("Order statuses fetch failed:", error);
