...
import { Eye, Phone, Plus, WandSparkles } from "lucide-react";
    ...
    <section className="flex flex-col gap-4">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-wrap items-end gap-3 flex-1 justify-end">
          ...
          <Button
            type="button"
            className="h-11 gap-2 rounded-full border-none bg-brand-accent px-5 text-brand-white hover:bg-brand-accent/90"
          >
