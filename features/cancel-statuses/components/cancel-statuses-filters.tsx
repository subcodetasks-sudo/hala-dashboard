...
type CancelStatusesFiltersProps = {
  value: CancelStatusFilterValues;
  onChange: (next: CancelStatusFilterValues) => void;
  onApply: () => void;
};

const STATUS_OPTIONS: {
  value: CancelStatusFilterValues["active"];
...
export default function CancelStatusesFilters({
  value,
  onChange,
  onApply,
}: CancelStatusesFiltersProps) {
        ...
        <div className="flex w-36 shrink-0 flex-col gap-1.5 sm:w-40">
          ...
          <Select
            ...
            onValueChange={(active) =>
              onChange({
                ...value,
                active: active as CancelStatusFilterValues["active"],
              })
            }
          >
