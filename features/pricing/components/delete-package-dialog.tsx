...
import { useDeletePackage } from "@/features/pricing/queries/use-delete-package";
...
export default function DeletePackageDialog({
  ...
  const t = useTranslations("Pricing.packages.deleteDialog");
  const locale = useLocale();
  const deleteItem = useDeletePackage();
