...
import { useCreateCity } from "@/features/cities/queries/use-create-city";
import { useUpdateCity } from "@/features/cities/queries/use-update-city";
import { createCityFormSchema } from "@/features/cities/schemas/city-form-schema";
import type { CityFormValues, CityRow } from "@/features/cities/types";
...
export default function CityFormDialog({
  ...
  const t = useTranslations("Cities.cityDialog");
