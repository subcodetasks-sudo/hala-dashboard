...
import type { BlogFilterValues } from "@/features/content-management/types";
import { cn } from "@/lib/utils";

type BlogsFiltersProps = {
  value: BlogFilterValues;
  onChange: (next: BlogFilterValues) => void;
  onApply: () => void;
};

const STATUS_OPTIONS: {
  value: BlogFilterValues["status"];
        ...
        <div className="flex w-36 shrink-0 flex-col gap-1.5 sm:w-40">
          ...
          <Select
            ...
            onValueChange={(status) =>
              onChange({
                ...value,
                status: status as BlogFilterValues["status"],
              })
            }
          >
