...
import DeleteFaqItemDialog from "@/features/content-management/components/delete-faq-item-dialog";
import FaqItemFormDialog from "@/features/content-management/components/faq-item-form-dialog";
import ViewFaqItemDialog from "@/features/content-management/components/view-faq-item-dialog";
import type { FaqItemRow } from "@/features/content-management/types";

type FaqItemRowActionsProps = {
  item: FaqItemRow;
};

export default function FaqItemRowActions({ item }: FaqItemRowActionsProps) {
  const t = useTranslations("ContentManagement.faqs.items.table");
  ...
  return (
    <>
      ...
      <ViewFaqItemDialog open={viewOpen} onOpenChange={setViewOpen} item={item} />
      <FaqItemFormDialog open={editOpen} onOpenChange={setEditOpen} item={item} />
      <DeleteFaqItemDialog
        open={deleteOpen}
