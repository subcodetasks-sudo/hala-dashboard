...
import { useDeleteLegalSection } from "@/features/content-management/queries/use-delete-legal-section";
import type {
  LegalPageKind,
  LegalSectionRow,
} from "@/features/content-management/types";

type DeleteLegalSectionDialogProps = {
  page: LegalPageKind;
  open: boolean;
...
export default function DeleteLegalSectionDialog({
  page,
  open,
  onOpenChange,
  item,
}: DeleteLegalSectionDialogProps) {
  const t = useTranslations("ContentManagement.legal.sections.deleteDialog");
  const locale = useLocale();
  const deleteItem = useDeleteLegalSection(page);
