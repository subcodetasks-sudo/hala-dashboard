...
import { useDeleteStatisticItem } from "@/features/content-management/queries/use-delete-statistic-item";
import type { StatisticItemRow } from "@/features/content-management/types";

type DeleteStatisticItemDialogProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  item: StatisticItemRow | null;
};

export default function DeleteStatisticItemDialog({
  open,
  onOpenChange,
  item,
}: DeleteStatisticItemDialogProps) {
  const t = useTranslations("ContentManagement.statistics.items.deleteDialog");
  const locale = useLocale();
  const deleteItem = useDeleteStatisticItem();
