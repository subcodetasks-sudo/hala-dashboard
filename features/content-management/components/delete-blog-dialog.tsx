...
import { useDeleteBlog } from "@/features/content-management/queries/use-delete-blog";
...
export default function DeleteBlogDialog({
  ...
  const t = useTranslations("ContentManagement.blog.deleteDialog");
  const locale = useLocale();
  const deleteBlog = useDeleteBlog();
  const isPending = deleteBlog.isPending;
