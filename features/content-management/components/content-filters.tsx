...
import type { ContentFilterValues } from "@/features/content-management/types";
import { cn } from "@/lib/utils";

type ContentFiltersProps = {
  value: ContentFilterValues;
  onChange: (next: ContentFilterValues) => void;
  onApply: () => void;
};

const STATUS_OPTIONS: {
  value: ContentFilterValues["status"];
        ...
        <div className="flex w-36 shrink-0 flex-col gap-1.5 sm:w-40">
          ...
          <Select
            ...
            onValueChange={(status) =>
              onChange({
                ...value,
                status: status as ContentFilterValues["status"],
              })
            }
          >
