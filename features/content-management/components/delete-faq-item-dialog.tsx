...
import { useDeleteFaqItem } from "@/features/content-management/queries/use-delete-faq-item";
import type { FaqItemRow } from "@/features/content-management/types";

type DeleteFaqItemDialogProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  item: FaqItemRow | null;
};

export default function DeleteFaqItemDialog({
  open,
  onOpenChange,
  item,
}: DeleteFaqItemDialogProps) {
  const t = useTranslations("ContentManagement.faqs.items.deleteDialog");
