...
import { useDeleteServiceItem } from "@/features/content-management/queries/use-delete-service-item";
import type { ServiceItemRow } from "@/features/content-management/types";

type DeleteServiceItemDialogProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  item: ServiceItemRow | null;
};

export default function DeleteServiceItemDialog({
  open,
  onOpenChange,
  item,
}: DeleteServiceItemDialogProps) {
  const t = useTranslations("ContentManagement.services.items.deleteDialog");
