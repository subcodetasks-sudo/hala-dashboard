...
type ViewServiceItemDialogProps = {
  open: boolean;
...
export default function ViewServiceItemDialog({
  open,
  onOpenChange,
  item,
}: ViewServiceItemDialogProps) {
  const t = useTranslations("ContentManagement.services.items.viewDialog");
          ...
          {item ? (
            <>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <DetailRow label={t("titleAr")}>
                  {item.titleAr || "—"}
                </DetailRow>
                <DetailRow label={t("titleEn")}>
                  {item.titleEn || "—"}
                </DetailRow>
              </div>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <DetailRow label={t("buttonTextAr")}>
                  {item.buttonTextAr || "—"}
                </DetailRow>
                <DetailRow label={t("buttonTextEn")}>
                  {item.buttonTextEn || "—"}
                </DetailRow>
              </div>

              <DetailRow label={t("buttonLink")}>
                {item.buttonLink || "—"}
              </DetailRow>
