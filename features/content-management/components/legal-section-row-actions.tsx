...
import DeleteLegalSectionDialog from "@/features/content-management/components/delete-legal-section-dialog";
import LegalSectionFormDialog from "@/features/content-management/components/legal-section-form-dialog";
import ViewLegalSectionDialog from "@/features/content-management/components/view-legal-section-dialog";
import type {
  LegalPageKind,
  LegalSectionRow,
} from "@/features/content-management/types";

type LegalSectionRowActionsProps = {
  page: LegalPageKind;
  item: LegalSectionRow;
};

export default function LegalSectionRowActions({
  page,
  item,
}: LegalSectionRowActionsProps) {
  const t = useTranslations("ContentManagement.legal.sections.table");
