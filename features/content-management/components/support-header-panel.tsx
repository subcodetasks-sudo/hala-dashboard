...
export default function SupportHeaderPanel() {
  const t = useTranslations("ContentManagement.support");
  const { data: header, isLoading, isError, error, refetch } =
    useLegalHeader("support");
  const upsertHeader = useUpsertLegalHeader("support");
