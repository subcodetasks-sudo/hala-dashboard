...
import type { LegalHeaderFormValues } from "@/features/content-management/types";

type LegalHeaderFormMessages = {
...
export function createLegalHeaderFormSchema(messages: LegalHeaderFormMessages) {
  return z.object({
...
export type LegalHeaderFormSchema = z.infer<
  ReturnType<typeof createLegalHeaderFormSchema>
>;

export const EMPTY_LEGAL_HEADER_FORM_VALUES: LegalHeaderFormValues = {
  contentAr: "",
  contentEn: "",
  titleAr: "",
  titleEn: "",
