...
import type { FaqsHeaderFormValues } from "@/features/content-management/types";

type FaqsHeaderFormMessages = {
...
export function createFaqsHeaderFormSchema(messages: FaqsHeaderFormMessages) {
  return z.object({
...
export type FaqsHeaderFormSchema = z.infer<
  ReturnType<typeof createFaqsHeaderFormSchema>
>;

export const EMPTY_FAQS_HEADER_FORM_VALUES: FaqsHeaderFormValues = {
  contentAr: "",
  contentEn: "",
  titleAr: "",
  titleEn: "",
